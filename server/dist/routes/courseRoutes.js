...
const upload = (0, multer_1.default)({ storage: multer_1.default.memoryStorage() }); // multer memory storage
...
router.get("/:courseId", (0, express_2.requireAuth)(), upload.single("image"), courseController_1.updateCourse);
