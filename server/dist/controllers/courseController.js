...
const listCourses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(500).json({ message: "Error getting the courses", error });
    }
});
...
const getCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.json({ message: "Courses retreived successfully", data: course });
    }
    catch (error) {
        res.status(500).json({ message: "Error getting the course", error });
    }
});
