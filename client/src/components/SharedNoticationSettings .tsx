...
const SharedNoticationSettings  = ({title = "Notification Settings", subtitle="Manage your notifications"} : SharedNotificationSettingsProps) => {
    const {user} = useUser();
    ...
    <div className='notification-settings'>
        ...
        <Form {...methods}>
            ...
            >
                ...
                <Button type="submit" className='notifications-settings__submit'>Update Settings</Button>
            </form>
        </Form>
     </div>
  )
...
export default SharedNoticationSettings